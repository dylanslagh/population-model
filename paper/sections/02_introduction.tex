...
\UnEquivalentTwentyOneFifty{} billion. Same base data, same engine. All of the
difference is in what one assumes about fertility.
...
so the standard deviation is more than half the mean. And the variation carries:
adult children of larger families have somewhat larger families themselves, with
reported parent--child correlations usually between 0.1 and 0.2
\citep{murphy1999,murphy2013}.

Put those two together and something follows that a national-rate model cannot
express. The parents of the next generation are not a random sample of this one
