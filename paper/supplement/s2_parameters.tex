...
\centering
\footnotesize
\input{generated/parameter_table}
...
The range column is propagated through the main paper's parameter ensemble and boundary grid; it is a stated
...
States cohorts 1947--1956 \citep{cdccohort}. See the main paper's calibration section for the tail
...
The last of these is the reason the main paper reports a threshold rather than a total. Fitting the
...
control a headline it cannot support --- at \LadderPressureLoss{} billion against the mechanism's \LadderMainstreamGain{} billion.
