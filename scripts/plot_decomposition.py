...
def main() -> int:
    ...
    fig.text(
        ...
        chr(10).join([
            ...
            "its demographic rates are the UN medium path; all eight sourced "
            "parameters are checked and five others are scenario knobs. The "
            "published band contains no migration uncertainty.",
        ]),
